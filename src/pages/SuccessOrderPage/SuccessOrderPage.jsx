            ...
            <div className="content-footer">
              <div className="rating">
                ...
                <div className="rating-stars">
                  <button
                    className={`star ${activeStar.one}`}
                    id="one"
                    onClick={onClickStar}
                  ></button>
                  <button
                    className={`star ${activeStar.two}`}
                    id="two"
                    onClick={onClickStar}
                  ></button>
                  <button
                    className={`star ${activeStar.three}`}
                    id="three"
                    onClick={onClickStar}
                  ></button>
                  <button
                    className={`star ${activeStar.four}`}
                    id="four"
                    onClick={onClickStar}
                  ></button>
                  <button
                    className={`star ${activeStar.five}`}
                    id="five"
                    onClick={onClickStar}
                  ></button>
                </div>
