...
const PassangerCard = ({ show, count }) => {
  ...
  const onClickButton = () => {
    ...
    if (passanger.age === "Взрослый") {
      if (
        validatePassportSeries(passanger.series) &&
        validatePassportNumber(passanger.number) &&
        checkEmptyFields(passanger) &&
        validateDate(passanger.date)
      ) {
        setValidate(false);
        setError("Готово");
    ...
    if (passanger.age === "Детский") {
      if (
        validateBirthNumber(passanger.birthNumber) &&
        checkEmptyFields(passanger) &&
        validateDate(passanger.date)
      ) {
        setValidate(false);
      ...
      {show ? (
        <div className="passanger-content">
            ...
            <div className="passanger-birth">
              <div className="passanger-select-gender">
                ...
                <div className="select-gender">
                  <button
                    className={
                      passanger.gender === "male"
                        ? "gender-select-color gender-man active"
                        : "gender-select-color gender-man"
                    }
                    id="male"
          ...
          <div className="passanger-restric-check">
            ...
            />
            <label htmlFor="cb" className="checkbox-text">
          ...
          <div className="passanger-footer">
            <button className="passanger-footer-button" onClick={onClickButton}>
              Следующий пассажир
            </button>
          </div>
        </div>
