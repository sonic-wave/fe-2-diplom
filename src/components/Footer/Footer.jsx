...
import mailIcon from "../../img/footer/mail.png";
import skypeIcon from "../../img/footer/skype.png";
        ...
        <div className="footer-content top">
          <div className="footer-content_block block-left">
            ...
            <ul className="block-list">
              <Item link={phoneIcon} alt="phone" text="8 (800) 000 00 00" />
              <Item link={mailIcon} alt="mail" text="inbox@mail.ru" />
              <Item link={skypeIcon} alt="skype" text="tu.train.tickets" />
              <Item
                link={locationIcon}
                alt="location"
                text={
          ...
          <div className="footer-content_block block-right">
            ...
            <div className="block-social-group">
              <h4 className="block-title social-group-title">
